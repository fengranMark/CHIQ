...
from data_format import padding_seq_to_same_length, Retrieval_qrecc, Retrieval_topiocqa, Search_q_Retrieval, keywords_Retrieval
import os
from os import path
...
def get_test_query_embedding(args):
    ...
    #test_dataset = keywords_Retrieval(args, tokenizer, args.test_file_path)
...
def get_args():
    ...
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/TopiOCQA/mistral_test_with_doc_newcontext_search_q_reorder.json")
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/combine_topiocqa/llama_TopiOCQA_test_AD+FT.json")
    parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/QR_topiocqa/Flant5large-search-nop-search_q-best-model.json")
    #parser.add_argument("--QR_filename", type=str, default="/media/nvme/fengran/output/QR_topiocqa/Flant5-search_q.json")
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/abbas/convqa/abbas2fengran/TopiOCQA_test_search_query_Mistral-7B-Instruct-v0.2_output.json")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="/media/nvme/fengran/index/ance_topiocqa")
    #parser.add_argument("--passage_offset2pid_path", type=str)
    parser.add_argument("--pretrained_encoder_path", type=str, default="/media/nvme/fengran/checkpoints/ad-hoc-ance-msmarco")
    parser.add_argument("--qrel_output_path", type=str, default="/media/nvme/fengran/output/ance_topiocqa")
    #parser.add_argument("--output_trec_file", type=str, default="llama_TopiOCQA_test_search_query+single_response+explain_question_cur.trec")
    parser.add_argument("--output_trec_file", type=str, default="Flant5large-search-nop-search_q-best-model.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="/media/nvme/fengran/TopiOCQA/topiocqa_qrel.tsv")

    parser.add_argument("--test_type", type=str, default="rewrite")
    parser.add_argument("--dataset", type=str, default="topiocqa")
    parser.add_argument("--expansion", type=bool, default=False)
...
if __name__ == '__main__':
    main()
    #print_trec_res("/media/nvme/fengran/output/ance_topiocqa/Flant5large-without-reorder-search_q-best-model.trec", "/media/nvme/fengran/TopiOCQA/topiocqa_qrel.tsv", rel_threshold=1)
