...
from data_format import padding_seq_to_same_length, Retrieval_qrecc, Retrieval_topiocqa, Search_q_Retrieval
import os
from os import path
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/QR_cast/mistral_cast19_flant5large-noinstruc.json")
    parser.add_argument("--exp_filename", type=str, default="/media/nvme/fengran/new_generation/cast19RM_test_single_response_Mistral-7B-Instruct-v0.2_output.json")
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/combine_cast/chatgpt_cast20_test_search_query.json")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="/media/nvme/fengran/index/ance_cast1920")
    ...
    parser.add_argument("--qrel_output_path", type=str, default="/media/nvme/fengran/output/ance_cast")
    parser.add_argument("--output_trec_file", type=str, default="mistral_cast19_flant5large-noinstruc.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="/media/nvme/fengran/cast19/qrels.tsv")

    parser.add_argument("--test_type", type=str, default="rewrite")
    parser.add_argument("--expansion", type=bool, default=True)
    ...
    parser.add_argument("--passage_block_num", type=int, default=8)
...
if __name__ == '__main__':
    main()
    #print_trec_res("/media/nvme/fengran/output/ance_cast/mistral_cast20_test_search_query+keywords.trec", "/media/nvme/fengran/cast20/qrels.tsv", rel_threshold=2)
