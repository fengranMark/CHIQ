...
from data_format import padding_seq_to_same_length, Retrieval_qrecc, Search_q_Retrieval, keywords_Retrieval
import os
from os import path
...
def get_args():
    ...
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/QReCC/mistral_QReCC_test_explain_question.json")
    #parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/combine_qrecc_new/mistral_QReCC_test_AD+FT.json")
    parser.add_argument("--test_file_path", type=str, default="/media/nvme/fengran/output/QR_qrecc/Flant5large-search-nop-search_q-best-model.json")
    #parser.add_argument("--QR_filename", type=str, default="/media/nvme/fengran/output/QR_qrecc/flant5large-search_q-noinstruc.json")
    parser.add_argument("--passage_embeddings_dir_path", type=str, default="/media/nvme/fengran/index/ance_qrecc")
    #parser.add_argument("--passage_offset2pid_path", type=stnr)
    parser.add_argument("--pretrained_encoder_path", type=str, default="/media/nvme/fengran/checkpoints/ad-hoc-ance-msmarco")
    parser.add_argument("--qrel_output_path", type=str, default="/media/nvme/fengran/output/ance_qrecc")
    parser.add_argument("--output_trec_file", type=str, default="Flant5large-search-nop-search_q-best-model.trec")
    parser.add_argument("--trec_gold_qrel_file_path", type=str, default="/media/nvme/fengran/QReCC/qrecc_qrel.tsv")
    ...
    parser.add_argument("--passage_block_num", type=int, default=43)
...
if __name__ == '__main__':
    #main()
    print_trec_res("/media/nvme/fengran/output/ance_qrecc/Flant5large-newcontextwithoutRJ-oracle-best-model.trec", "/media/nvme/fengran/QReCC/qrecc_qrel.tsv", rel_threshold=1)
    #print_trec_res("/media/nvme/fengran/output/ance_cast/cast19_llamaprompt_responseandreasoning_expansion.trec", "/media/nvme/fengran/cast19/qrels.tsv", rel_threshold=1)
