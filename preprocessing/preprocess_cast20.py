...
if __name__ == "__main__":
    ...
    parser.add_argument("--car_cbor", type=str, default="cast20/paragraphCorpus_new/dedup.articles-paragraphs.cbor")
    parser.add_argument("--msmarco_collection", type=str, default="cast20/msmarco.tsv")
    parser.add_argument("--duplicate_file", type=str, default="cast20/duplicate_list_v1.0.txt")
    parser.add_argument("--cast_dir", type=str, default="cast20")

    parser.add_argument("--out_data_dir", type=str, default="cast20")
    parser.add_argument("--out_collection_dir", type=str, default="cast20/collection")
    ...
    for auto_topic, manual_topic in zip(auto_raw, manual_raw):
        ...
        for auto_turn, manual_turn in zip(auto_turns, manual_turns):
            ...
            output_dict = {
                ...
                "cur_utt_text": copy.deepcopy(inputs)[-1],
                "ctx_utts_text": copy.deepcopy(inputs)[:-1],
                "oracle_utt_text": target,
