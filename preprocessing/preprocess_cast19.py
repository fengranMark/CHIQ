...
if __name__ == "__main__":
    ...
    parser.add_argument("--car_cbor", type=str, default="cast20/paragraphCorpus/dedup.articles-paragraphs.cbor")
    parser.add_argument("--msmarco_collection", type=str, default="cast20/collection.tsv")
    parser.add_argument("--duplicate_file", type=str, default="cast20/duplicate_file.tsv")
    parser.add_argument("--cast_dir", type=str, default="/media/nvme/fengran/cast19")

    parser.add_argument("--out_data_dir", type=str, default="cast19")
    ...
    # OUTPUT
    out_topics_file = os.path.join(args.out_data_dir, "eval_topics.json")
    ...
    out_collection_file = os.path.join(args.out_collection_dir, "cast1920_collection.tsv")
    ...
    for group in raw_data:
        ...
        for query in turn:
            ...
            record = {}
            record['sample_id'] = topic_number + '-' + query_number
            #record['topic_number'] = topic_number
            #record['query_number'] = query_number
            record['description'] = description
            record['title'] = title
            record['cur_utt_text'] = copy.deepcopy(queries)[-1]
            record['ctx_utts_text'] = copy.deepcopy(queries)[:-1]
            record['oracle_utt_text'] = all_annonated[topic_number][query_number]
