...
def get_args():
    ...
    parser.add_argument("--test_file", type = str, default="/media/nvme/fengran/QReCC/test.json")
    parser.add_argument("--default_file", type = str, default="/media/nvme/abbas/convqa/fengran2abbas/QReCC_test_default_query.json")
    parser.add_argument("--query_file", type = str, default="/media/nvme/fengran/output/combine_qrecc_new/llama_QReCC_test_AD+FT.json")
    #parser.add_argument("--query_file", type = str, default="/media/nvme/abbas/convqa/abbas2fengran/QReCC_test_search_query_Mistral-7B-Instruct-v0.2_output.json")
    ...
    parser.add_argument("--output_file_name", type=str, default="llama_QReCC_test_AD+FT.trec")
...
if __name__ == '__main__':
    args = get_args()
    run_bm25(args)
    #print_res("/media/nvme/fengran/output/ance_qrecc/ftflant5large2.25-oracle.trec", "/media/nvme/fengran/QReCC/qrecc_qrel.tsv", rel_threshold=1)
